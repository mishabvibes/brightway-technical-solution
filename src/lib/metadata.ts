...
export const OG_IMAGE = {
  ...
  width: 1200,
  height: 630,
  alt: "BrightWay electrician and plumber. Call +91 91881 26866.",
};

/** Site-wide Open Graph fields. Next.js REPLACES (not merges) a parent's openGraph object when a page
 *  defines its own, so every page must go through pageMetadata() to keep image, site name and locale. */
